...
import model.ANSI.ANSIJPanel;
import model.ANSI.ANSISideJPanel;
...
import model.contractor.ContractorJPanel;
import model.contractor.ContractorSideJPanel;
...
import model.materialDepot.MaterialDepotJPanel;
import model.materialDepot.MaterialDepotSideJPanel;
...
public class LoginJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(imgLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 400, 200));
        ...
        lblWelcome.setFont(new java.awt.Font("Yuanti SC", 1, 24)); // NOI18N
        ...
        drpRole.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Super Admin", "Community Admin", "Ingredient Supplier", "Manufacturer", "ANSI", "Distributor", "Material Depot", "Contractor", " " }));
    ...
    private void btnSignInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignInActionPerformed
        ...
        if (drpRole.getSelectedItem().equals("Ingredient Supplier")) {
            ...
            IngredientSupplier m = msq.validateIngredientSupplier(txtEmailId.getText(), password);
            if (m != null) {
            ...
            Manufacturer m = msq.validateManufacturer(txtEmailId.getText(), password);
            if (m != null) {
        ...
        else if (drpRole.getSelectedItem().equals("Contractor")) {
            ContractorSqlQuery msq = new ContractorSqlQuery();
            Contractor m = msq.validateContractor(txtEmailId.getText(), password);

            if (m != null) {
                splitPane.setLeftComponent(new ContractorSideJPanel(m));
                splitPane.setRightComponent(new ContractorJPanel(m));
        ...
        else if (drpRole.getSelectedItem().equals("Material Depot")) {
            MaterialDepotSqlQuery msq = new MaterialDepotSqlQuery();
            MaterialDepot m = msq.validateMaterialDepot(txtEmailId.getText(), password);

            if (m != null) {
                splitPane.setLeftComponent(new MaterialDepotSideJPanel(splitPane,m));
                splitPane.setRightComponent(new MaterialDepotJPanel(m));
            ...
            //ANSI Login
        } else if (drpRole.getSelectedItem().equals("ANSI")) {
            ANSISqlQuery msq = new ANSISqlQuery();
            ANSI m = msq.validateANSI(txtEmailId.getText(), password);

            if (m != null) {
                splitPane.setLeftComponent(new ANSISideJPanel(splitPane));
            splitPane.setRightComponent(new ANSIJPanel(splitPane));
            } else {
        ...
        //Distributor Login
            ...
            Distributor m = msq.validateDistributor(txtEmailId.getText(), password);
