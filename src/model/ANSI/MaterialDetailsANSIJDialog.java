 ...
 * @author Dell
 */
public class MaterialDetailsANSIJDialog extends javax.swing.JDialog {

    /**
     * Creates new form MaterialDetailsJDialog
     */
    public MaterialDetailsANSIJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblMaterialDetails = new javax.swing.JLabel();
        lblName = new javax.swing.JLabel();
        lclMaterialName = new javax.swing.JLabel();
        ...
        lblMaterialDetails.setBackground(new java.awt.Color(255, 255, 255));
        lblMaterialDetails.setFont(new java.awt.Font("Helvetica Neue", 1, 24)); // NOI18N
        lblMaterialDetails.setForeground(new java.awt.Color(102, 102, 102));
        lblMaterialDetails.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblMaterialDetails.setText("Material Details");
        getContentPane().add(lblMaterialDetails, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 590, 45));
        ...
        lclMaterialName.setFont(new java.awt.Font("Helvetica Neue", 1, 13)); // NOI18N
        lclMaterialName.setForeground(new java.awt.Color(102, 0, 153));
        lclMaterialName.setText("{Material Name}");
        getContentPane().add(lclMaterialName, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 60, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MaterialDetailsANSIJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MaterialDetailsANSIJDialog dialog = new MaterialDetailsANSIJDialog(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JLabel lblMaterialDetails;
    private javax.swing.JLabel lblName;
    private javax.swing.JLabel lblShellL;
    private javax.swing.JLabel lblShellLife;
    private javax.swing.JLabel lclMaterialName;
