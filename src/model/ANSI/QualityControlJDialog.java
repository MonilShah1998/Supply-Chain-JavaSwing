 ...
 * @author Dell
 */
public class QualityControlJDialog extends javax.swing.JDialog {

    /**
     * Creates new form MaterialDetailsJDialog
     */
    private static Material m;
    public QualityControlJDialog(java.awt.Frame parent, boolean modal,Material m) {
        super(parent, modal);
        initComponents();
        this.m = m;
    ...
    private void initComponents() {
        ...
        btnAccept.setText("Ready For Shippment");
        btnAccept.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAcceptActionPerformed(evt);
            }
        });
        getContentPane().add(btnAccept, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 230, 210, 30));
        ...
        if(m.getMaterial_Status().equals("Rejected") || m.getMaterial_Status().equals("Ready for Shipment")){
            btnReject.setEnabled(false);
            btnAccept.setEnabled(false);
            if(m.getMaterial_Status().equals("Ready for Shipment")){
                lblMsgBox.setText("Materials Approved for shipping.");
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QualityControlJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QualityControlJDialog dialog = new QualityControlJDialog(new javax.swing.JFrame(), true, m);
