 ...
 * @author Dell
 */
public class ANSIJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ANSIJPanel
     */
    javax.swing.JSplitPane splitPane;

    public ANSIJPanel(javax.swing.JSplitPane splitPane) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("American National Standards Institute");
     ...
     private void populateTable() {
        ...
        for (Material e : mList) {
            ...
            if ((e.getMaterial_Status().equals("Licensing")) ||
                 (e.getMaterial_Status().equals("Lab Tested")) ||
                    (e.getMaterial_Status().equals("Quality Control Checked")) ||
                    (e.getMaterial_Status().equals("Ready for Shipment"))
                    ) {
                model.addRow(row);
            }
