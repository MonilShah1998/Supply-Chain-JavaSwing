 ...
 * @author Dell
 */
public class UpdateMaterialDepotFormJPanel extends javax.swing.JPanel {

    /**
     * Creates new form MaterialDepotFormJPanel
     */
    private boolean validation;
    javax.swing.JSplitPane splitPane;
    MaterialDepot p;
    public UpdateMaterialDepotFormJPanel(javax.swing.JSplitPane splitPane,MaterialDepot p) {
        initComponents();
        this.splitPane=splitPane;
        this.p=p;
        formReset();
         txtMaterialDepotName.setText(p.getMaterialDepot_Name());
       txtLocation.setText(p.getMaterialDepot_Location());
        
        if(p.getMaterialDepot_Inventory_Size()==900) drpInventorySize.setSelectedIndex(0);
        if(p.getMaterialDepot_Inventory_Size()==1200) drpInventorySize.setSelectedIndex(1);
        if(p.getMaterialDepot_Inventory_Size()==4000) drpInventorySize.setSelectedIndex(2);
    ...
    private void initComponents() {
        ...
        lblMaterialDepotName = new javax.swing.JLabel();
        txtMaterialDepotName = new javax.swing.JTextField();
        valMaterialDepotName = new javax.swing.JLabel();
        ...
        lblHeader.setFont(new java.awt.Font("Helvetica Neue", 1, 36)); // NOI18N
        lblHeader.setForeground(new java.awt.Color(0, 51, 153));
        lblHeader.setText("Update Material Depot Details");
        jPanel2.add(lblHeader, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 30, 540, 90));

        lblMaterialDepotName.setFont(new java.awt.Font("Helvetica Neue", 1, 18)); // NOI18N
        lblMaterialDepotName.setForeground(new java.awt.Color(102, 102, 102));
        lblMaterialDepotName.setText("Material Depot Name");
        jPanel2.add(lblMaterialDepotName, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 120, 200, 30));

        txtMaterialDepotName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtMaterialDepotNameActionPerformed(evt);
            }
        });
        jPanel2.add(txtMaterialDepotName, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 150, 290, 30));

        valMaterialDepotName.setForeground(new java.awt.Color(255, 61, 0));
        valMaterialDepotName.setText("Please enter valid Material Depot Name");
        jPanel2.add(valMaterialDepotName, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 180, 290, 20));
    ...
    private void txtMaterialDepotNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtMaterialDepotNameActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtMaterialDepotNameActionPerformed
    ...
    private void btnsubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsubmitActionPerformed
        // TODO add your handling code here:
        String MaterialDepot_Name = txtMaterialDepotName.getText();
        ...
        MaterialDepotSqlQuery sql = new MaterialDepotSqlQuery();
        int result = 0;
        ...
        obj.setMaterialDepot_Id(p.getMaterialDepot_Id());
        obj.setEmail_Id(Email_Id);
        obj.setPassword(Password);
        obj.setMaterialDepot_Location(Location);
        obj.setMaterialDepot_Name(MaterialDepot_Name);
...
//            try {
//                a.sendMail(Email_Id,"AVS MaterialDepot -  Account Creation","MaterialDepot account created successfully !");
//            } catch (Exception ex) {
//                Logger.getLogger(PatientRegFormJPanel.class.getName()).log(Level.SEVERE, null, ex);
//            }
            result = sql.updateMaterialDepot(obj);        
        }
        if (result == 1) {
            formReset();        
            ...
            validation();
            JOptionPane.showMessageDialog(this, "MaterialDepot not created !");
...
/**
    ...
    private boolean validation() {
        ...
        System.out.println("MaterialDepot Name->" + MaterialDepot_Name);

        //Name Validation
        if (MaterialDepot_Name.length() <= 0) {
            valMaterialDepotName.setText("Please Enter Name");
            validation = false;
        }
        //Email_Id Validation
    ...
    private javax.swing.JLabel lblMaterialDepotName;
    private javax.swing.JLabel lblPassword;
    private javax.swing.JLabel lblPhoneNumber;
    private javax.swing.JLabel lbllogo;
    private javax.swing.JTextField txtEmailId;
    private javax.swing.JTextField txtLocation;
    private javax.swing.JTextField txtMaterialDepotName;
    private javax.swing.JPasswordField txtPassword;
    private javax.swing.JTextField txtPhoneNumber;
    private javax.swing.JLabel valEmailId;
    private javax.swing.JLabel valLocation;
    private javax.swing.JLabel valMaterialDepotName;
