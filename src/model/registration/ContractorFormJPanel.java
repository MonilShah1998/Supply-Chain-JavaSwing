 ...
 * @author Dell
 */
public class ContractorFormJPanel extends javax.swing.JPanel {
    ...
    public ContractorFormJPanel(javax.swing.JSplitPane splitPane) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblContractor.setText("Enter Contractor Details");
    ...
    private void btnsubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsubmitActionPerformed
        ...
        try{
            if(Utils.checkIfAccountExists(Email_Id, Password, "CONTRACTOR")) {
                formReset();
...
//            try {
//                a.sendMail(Email_Id,"AVS MaterialDepot -  Account Creation","Contractor account created successfully !");
//            } catch (Exception ex) {
//                Logger.getLogger(PatientRegFormJPanel.class.getName()).log(Level.SEVERE, null, ex);
//            }
            result = sql.createContractor(obj);        
        }
        if (result == 1) {
            formReset();        
