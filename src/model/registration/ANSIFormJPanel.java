 ...
 * @author Dell
 */
public class ANSIFormJPanel extends javax.swing.JPanel {
    ...
    public ANSIFormJPanel(javax.swing.JSplitPane splitPane) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblANSI.setText("Enter ANSI Details");
    ...
    private void btnsubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsubmitActionPerformed
        ...
        try{
            if(Utils.checkIfAccountExists(Email_Id, Password, "ANSI")) {
                formReset();
