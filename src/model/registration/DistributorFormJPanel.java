...
public class DistributorFormJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel2.add(lbllogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 630, 190, 170));
    ...
    private void btnsubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsubmitActionPerformed
        ...
        try{
            if(Utils.checkIfAccountExists(Email_Id, Password, "DISTRIBUTOR")) {
                formReset();
...
//            try {
//                a.sendMail(Email_Id,"AVS MaterialDepot -  Account Creation","Distributor account created successfully !");
//            } catch (Exception ex) {
