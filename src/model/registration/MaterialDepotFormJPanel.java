 ...
 * @author Dell
 */
public class MaterialDepotFormJPanel extends javax.swing.JPanel {
    ...
    public MaterialDepotFormJPanel(javax.swing.JSplitPane splitPane) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblHeader.setText("Enter Material Depot Details");
        ...
        jPanel2.add(lblMaterialDepotName, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 120, 190, 30));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/util/images/Pharmacy.jpeg"))); // NOI18N
    ...
    private void btnsubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsubmitActionPerformed
        ...
        try{
            if(Utils.checkIfAccountExists(Email_Id, Password, "MATERIAL_DEPOT")) {
                formReset();
            ...
            formReset();
            JOptionPane.showMessageDialog(this, "There was an error creating the account, Please try again.");
...
//            }
            result = sql.createMaterialDepot(obj);        
        }
        if (result == 1) {
            formReset();        
            ...
            validation();
            JOptionPane.showMessageDialog(this, "Material Depot not created !");
