...
public class ManufacturerFormJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel2.add(lbllogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 630, 200, 170));
        jPanel2.add(datechooserDateofEst, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 430, 290, 30));

        comboboxMaterial.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pre cast", "cement", "Block", "Metal", "Chemical" }));
    ...
    private void btnsubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsubmitActionPerformed
        ...
        try{
            if(Utils.checkIfAccountExists(Email_Id, Password, "MANUFACTURER")) {
                formReset();
