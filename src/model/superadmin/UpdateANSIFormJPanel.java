 ...
 * @author Dell
 */
public class UpdateANSIFormJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ANSIFormJPanel
     */
    private boolean validation;
    javax.swing.JSplitPane splitPane;
    ANSI ANSI;
    public UpdateANSIFormJPanel(javax.swing.JSplitPane splitPane,ANSI ANSI) {
        initComponents();
        this.splitPane=splitPane;
        this.ANSI=ANSI;
        comboboxCountry.setSelectedIndex(0);
        formReset();
        txtName.setText(ANSI.getANSI_Board_Name());
        txtCity.setText(ANSI.getANSI_City());
        comboboxCountry.setSelectedItem(ANSI.getANSI_Country());
        txtEmailId.setText(ANSI.getEmail_Id());
        txtPassword.setText(ANSI.getPassword());
        txtPhoneNumber.setText(ANSI.getPhone_No());
    }
    ...
    private void initComponents() {
        ...
        lblANSI.setFont(new java.awt.Font("Helvetica Neue", 1, 36)); // NOI18N
        lblANSI.setForeground(new java.awt.Color(0, 51, 153));
        lblANSI.setText("Update ANSI Details");
        jPanel2.add(lblANSI, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 30, 540, 90));
    ...
    private void btnsubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsubmitActionPerformed
        ...
        String Password = txtPassword.getText();
         ...
         ANSISqlQuery sql = new ANSISqlQuery();
         int result=0;
         
         ANSI obj = new ANSI();
         obj.setANSI_Id(ANSI.getANSI_Id());
         ...
         System.out.println("ANSI Object->"+obj);
          if (validation()) {
//              testEmail a = new testEmail();
//            try {
//                a.sendMail(Email_Id,"AVS MaterialDepot -  Account Creation","ANSI account created successfully !");
//            } catch (Exception ex) {
//                Logger.getLogger(PatientRegFormJPanel.class.getName()).log(Level.SEVERE, null, ex);
//            }
         result = sql.updateANSI(obj);
        }
        if (result == 1) {
            formReset();        
            ...
            validation();
            JOptionPane.showMessageDialog(this, "ANSI not created !");
    ...
    private boolean validation() {
        ...
        System.out.println("ANSI Name->" + name);
