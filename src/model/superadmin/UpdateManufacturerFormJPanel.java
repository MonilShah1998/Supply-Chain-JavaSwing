 ...
 * @author Dell
 */
public class UpdateManufacturerFormJPanel extends javax.swing.JPanel {
    ...
    Manufacturer m;
    public UpdateManufacturerFormJPanel(javax.swing.JSplitPane splitPane,Manufacturer m) {
        initComponents();
        this.splitPane=splitPane;
        this.m=m;
        formReset();
        txtName.setText(m.getManufacturer_Name());
        txtLocation.setText(m.getManufacturer_Location());
        comboboxMaterial.setSelectedItem(m.getType_Of_Material());
        datechooserDateofEst.setDate(m.getManufacturer_Date_Of_Establishment());
        txtEmailId.setText(m.getEmail_Id());
        txtPassword.setText(m.getPassword());
        txtPhoneNumber.setText(m.getPhone_No());
    }
    ...
    private void initComponents() {
        ...
        lblTypeOfMaterial = new javax.swing.JLabel();
        ...
        lblHeading.setText("Update Manufacturer Details");
        ...
        lblTypeOfMaterial.setFont(new java.awt.Font("Helvetica Neue", 1, 18)); // NOI18N
        lblTypeOfMaterial.setForeground(new java.awt.Color(102, 102, 102));
        lblTypeOfMaterial.setText("Type of Material");
        jPanel2.add(lblTypeOfMaterial, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, 170, 30));
        ...
        comboboxMaterial.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pre cast", "Cement", "Block", "Metal", "Timber", " " }));
        comboboxMaterial.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comboboxMaterialActionPerformed(evt);
            }
        });
        jPanel2.add(comboboxMaterial, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 340, 290, 30));
    ...
    private void btnsubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsubmitActionPerformed
        ...
        String Manufacturer_Name = txtName.getText();
        String Manufacturer_Location = txtLocation.getText();
        String Manufacturer_Material_Type= " ";
        if(comboboxMaterial.getSelectedIndex()==0) Manufacturer_Material_Type = "Tablets";
        if(comboboxMaterial.getSelectedIndex()==1) Manufacturer_Material_Type = "Capsules";
        if(comboboxMaterial.getSelectedIndex()==2) Manufacturer_Material_Type = "Syrups";
        if(comboboxMaterial.getSelectedIndex()==3) Manufacturer_Material_Type = "Injections";
        if(comboboxMaterial.getSelectedIndex()==4) Manufacturer_Material_Type = "Implants";
        if(comboboxMaterial.getSelectedIndex()==5) Manufacturer_Material_Type = "Ointments";
        if(comboboxMaterial.getSelectedIndex()==6) Manufacturer_Material_Type = "Vitamins";
        ...
        obj.setManufacturer_Id(m.getManufacturer_Id());
        obj.setManufacturer_Name(Manufacturer_Name);
        obj.setManufacturer_Location(Manufacturer_Location);
        obj.setType_Of_Material(Manufacturer_Material_Type);
...
//            try {
//                a.sendMail(Email_Id,"AVS MaterialDepot -  Account Creation","Manufacturer account created successfully !");
//            } catch (Exception ex) {
//                Logger.getLogger(PatientRegFormJPanel.class.getName()).log(Level.SEVERE, null, ex);
//            }
            result = sql.updateManufacturer(obj);        
        }
        if (result == 1) {
            formReset();        
    ...
    private javax.swing.JLabel lblTypeOfMaterial;
