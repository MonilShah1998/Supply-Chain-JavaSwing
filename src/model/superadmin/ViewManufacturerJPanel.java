...
public class ViewManufacturerJPanel extends javax.swing.JPanel {
    ...
    public ViewManufacturerJPanel(javax.swing.JSplitPane splitPane) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblIS.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Location", "Type of Material", "Date", "Email Id", "Password", "Phone  Number"
            }
        ) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        mList = msq.readAllManufacturer();
        Manufacturer p = mList.get(selectedRow);
    ...
    private void btnViewMaterialDepotActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewMaterialDepotActionPerformed
        ...
        splitPane.setRightComponent(new UpdateManufacturerFormJPanel(splitPane, p));
        populateTable();
    ...
    private void populateTable() {
        ...
        for (Manufacturer e : mList) {
            System.out.println(e);
            Object row[] = new Object[10];
            row[0] = e.getManufacturer_Name();
            row[1] = e.getManufacturer_Location();
            row[2] = e.getType_Of_Material();
            row[3] = e.getManufacturer_Date_Of_Establishment();
            row[4] = e.getEmail_Id();
            row[5] = e.getPassword();
            row[6] = e.getPhone_No();
