 ...
 * @author Dell
 */
public class ContractorJDialog extends javax.swing.JDialog {
    ...
    public ContractorJDialog(java.awt.Frame parent, boolean modal,Material m,Contractor h) {
        super(parent, modal);
        initComponents();
        this.m = m;
        this.contractor = h;
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnAccept, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 240, 150, 30));
    ...
    private void btnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptActionPerformed
        ...
        ContractorOrderBook hsb = new ContractorOrderBook();
        hsb.setContractor_Id(contractor.getContractor_Id());
        hsb.setMaterial_Id(m.getId());
        hsb.setStatus("Ordered");
        msq.createContractorOrderBook(hsb);
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContractorJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ContractorJDialog dialog = new ContractorJDialog(new javax.swing.JFrame(), true,m,contractor);
