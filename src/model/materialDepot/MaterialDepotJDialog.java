 ...
 * @author Dell
 */
public class MaterialDepotJDialog extends javax.swing.JDialog {

    /**
     * Creates new form ContractorJDialog
     */
    private static Material m;
    private static MaterialDepot materialDepot;
    public MaterialDepotJDialog(java.awt.Frame parent, boolean modal,Material m,MaterialDepot h) {
        super(parent, modal);
        initComponents();
        this.m = m;
        this.materialDepot = h;
    ...
    private void btnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptActionPerformed
        ...
        MaterialDepotOrderBook hsb = new  MaterialDepotOrderBook();
        hsb.setMaterialDepot_Id(materialDepot.getMaterialDepot_Id());
        hsb.setMaterial_Id(m.getId());
        hsb.setStatus("Ordered");
        msq.createMaterialDepotOrderBook(hsb);
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MaterialDepotJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MaterialDepotJDialog dialog = new MaterialDepotJDialog(new javax.swing.JFrame(), true,m,materialDepot);
