...
public class LicensingJDialog extends javax.swing.JDialog {
    ...
    public LicensingJDialog(java.awt.Frame parent, boolean modal,Material m) {
        super(parent, modal);
        initComponents();
        this.m = m;
    ...
    private void initComponents() {
        ...
        btnAccept.setText("LICENSING");
        btnAccept.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAcceptActionPerformed(evt);
            }
        });
        getContentPane().add(btnAccept, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 230, 140, 30));
    ...
    private void DisplayBtn(){
        if(m.getMaterial_Status().equals("Rejected") || m.getMaterial_Status().equals("Licensing") || m.getMaterial_Status().equals("Lab Tested")){
            btnReject.setEnabled(false);
            btnAccept.setEnabled(false);
            if(m.getMaterial_Status().equals("Licensing") || m.getMaterial_Status().equals("Lab Tested")){
                lblMsgBox.setText("Waiting for Approval. Kindly contact the ANSI");
            }
            else{
    ...
    private void btnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptActionPerformed
        // TODO add your handling code here:
        MaterialSqlQuery msq = new MaterialSqlQuery();
        m.setMaterial_Status("Licensing");
        msq.updateMaterial(m);
        setVisible(false);
