 ...
 * @author Dell
 */
public class RnDJDialog extends javax.swing.JDialog {

    /**
     * Creates new form MaterialDetailsJDialog
     */
    private static Material m;
    public RnDJDialog(java.awt.Frame parent, boolean modal,Material m) {
        super(parent, modal);
        initComponents();
        this.m = m;
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblMsgBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 270, 610, 20));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void DisplayBtn(){
        if(m.getMaterial_Status().equals("Rejected") || m.getMaterial_Status().equals("Ordered Ingredients")){
            btnReject.setEnabled(false);
            btnAccept.setEnabled(false);
            if(m.getMaterial_Status().equals("Ordered Ingredients")){
                lblMsgBox.setText("Your order has been placed. Kindly contact the Supplier");
            }
            else{
                lblMsgBox.setText("Your order has been Rejected.");
    ...
    private void btnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptActionPerformed
        // TODO add your handling code here:
        MaterialSqlQuery msq = new MaterialSqlQuery();
        m.setMaterial_Status("Ordered Ingredients");
        msq.updateMaterial(m);
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RnDJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RnDJDialog dialog = new RnDJDialog(new javax.swing.JFrame(), true, m);
