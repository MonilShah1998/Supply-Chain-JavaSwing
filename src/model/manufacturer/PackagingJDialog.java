 ...
 * @author Dell
 */
public class PackagingJDialog extends javax.swing.JDialog {

    /**
     * Creates new form MaterialDetailsJDialog
     */
    private static Material m;
    public PackagingJDialog(java.awt.Frame parent, boolean modal,Material m) {
        super(parent, modal);
        initComponents();
        this.m = m;
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnAccept, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 240, 40, 30));
        ...
        lblMsgBox.setBackground(new java.awt.Color(255, 255, 255));
        lblMsgBox.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lblMsgBox.setForeground(new java.awt.Color(0, 153, 51));
        getContentPane().add(lblMsgBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 240, 340, 30));
    ...
    private void DisplayBtn(){
        if(m.getMaterial_Status().equals("Ready for Shipment")){
            lblMsgBox.setText("Kindly create a Package for Shipping");
            lblMsgBox.setForeground(Color.blue);
        }
        if(m.getMaterial_Status().equals("Available")){
            lblMsgBox.setText("This order is marked for Shipping");
        }         
    }
...
//        if(m.getMaterial_Status().equals("Certified"))
//            m.setMaterial_Status("Ready for Shipment");
...
//        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PackagingJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PackagingJDialog dialog = new PackagingJDialog(new javax.swing.JFrame(), true, m);
