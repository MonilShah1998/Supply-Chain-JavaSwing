...
public class PackagingJPanel extends javax.swing.JPanel {
    ...
    public PackagingJPanel(javax.swing.JSplitPane splitPane,Manufacturer manufacturer) {
        ...
        this.mList = msq.readAllMaterial();
        this.splitPane=splitPane;
        for(Material m:mList){
            if(m.getMaterial_Status().equals("Ready for Shipment")){
                drpMaterialName.addItem(m.getMaterial_Name());
            }
        }
    }
    ...
    private void initComponents() {
        ...
        lblMaterialPrice = new javax.swing.JLabel();
        ...
        drpMaterialName = new javax.swing.JComboBox<>();
        ...
        lblMaterialPrice.setFont(new java.awt.Font("Helvetica Neue", 1, 18)); // NOI18N
        lblMaterialPrice.setForeground(new java.awt.Color(102, 102, 102));
        lblMaterialPrice.setText("Price");
        panInventoryManagement.add(lblMaterialPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 120, 290, 30));
        ...
        drpMaterialName.setForeground(new java.awt.Color(0, 0, 153));
        drpMaterialName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                drpMaterialNameActionPerformed(evt);
            }
        });
        panInventoryManagement.add(drpMaterialName, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 290, 30));
    ...
    private void btnsubmitMedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsubmitMedActionPerformed
        // TODO add your handling code here:
         MaterialSqlQuery msq = new MaterialSqlQuery();
         var materialName = drpMaterialName.getSelectedItem();
         Material selectedMaterial = null;
        for (Material m : mList) {
            if (m.getMaterial_Name().equals(materialName)) {
                selectedMaterial = m;
                break;
            }
        }
        selectedMaterial.setMaterial_Status("Available");
        msq.updateMaterial(selectedMaterial);
        populateTable();
        splitPane.setRightComponent(new SubmitGifJPanel());
    }//GEN-LAST:event_btnsubmitMedActionPerformed

    private void drpMaterialNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_drpMaterialNameActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_drpMaterialNameActionPerformed
    ...
    private void populateTable() {
        ...
        for (Material e : mList) {
            ...
            if ((e.getMaterial_Status().equals("Ready for Shipment"))
                    || (e.getMaterial_Status().equals("Available")) ){
                model.addRow(row);
            }
    ...
    private javax.swing.JComboBox<String> drpMaterialName;
    ...
    private javax.swing.JLabel lblMaterialPrice;
