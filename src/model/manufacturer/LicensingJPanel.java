...
public class LicensingJPanel extends javax.swing.JPanel {
    ...
    private void populateTable() {
        ...
        for(Material e: mList){
            ...
            if((e.getMaterial_Status().equals("Ingredients FullFilled") && manufacturer.getManufacturer_Name().equals(e.getManufacturer_Name()))
                    || (e.getMaterial_Status().equals("Lab Tested") && manufacturer.getManufacturer_Name().equals(e.getManufacturer_Name()))
                    || (e.getMaterial_Status().equals("Licensing") && manufacturer.getManufacturer_Name().equals(e.getManufacturer_Name())) )
            model.addRow(row);
