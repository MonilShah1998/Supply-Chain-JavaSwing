...
public class DistributorJDialog extends javax.swing.JDialog {
    ...
    public DistributorJDialog(java.awt.Frame parent, boolean modal,Material m, String type, String orderStatus) {
        super(parent, modal);
        initComponents();
        this.m = m;
        this.type = type;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 610, 45));
    ...
    private void setBtnText(){
        if(orderStatus.isEmpty() && type.isEmpty()){
            btnAccept.setVisible(false);
            btnReject.setVisible(false);
            return;
        }
        if(orderStatus.equals("Ordered")){
            btnAccept.setText("Deliver");
            btnReject.setVisible(false);
        }else{
            btnAccept.setVisible(false);
        }
    ...
    private void btnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptActionPerformed
        // TODO add your handling code here:
        MaterialSqlQuery msq = new MaterialSqlQuery();
        if(btnAccept.getLabel().equals("Deliver")){
//            m.setMaterial_Status("Delivered");
              if(type.equals("H")){
                  ...
                  mList = msq_h_sql.readAllContractorOrderBook();
                  for(ContractorOrderBook hob : mList){
                      if(hob.getMaterial_Id() == m.getId()){
                          hob.setStatus("Delivered");
                          msq_h_sql.updateContractorOrderBook(hob);
                      }
                  }
                ...
                mList = msq_p_sql.readAllMaterialDepotOrderBook();
                for(MaterialDepotOrderBook pob : mList){
                      if(pob.getMaterial_Id() == m.getId()){
                          pob.setStatus("Delivered");
                          msq_p_sql.updateMaterialDepotOrderBook(pob);
                      }
                  }
              }
        }else{
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DistributorJDialog dialog = new DistributorJDialog(new javax.swing.JFrame(), true, m, type, orderStatus);
