 ...
 * @author Dell
 */
public class IndgJDialog extends javax.swing.JDialog {

    /**
     * Creates new form MaterialDetailsJDialog
     */
    private static Material m;
    public IndgJDialog(java.awt.Frame parent, boolean modal,Material m) {
        super(parent, modal);
        initComponents();
        this.m = m;
    ...
    private void initComponents() {
        ...
        btnAccept.setText("SUPPLY INGREDIENTS");
        btnAccept.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAcceptActionPerformed(evt);
            }
        });
        getContentPane().add(btnAccept, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 230, 200, 30));
    ...
    private void DisplayBtn(){
        if(m.getMaterial_Status().equals("Rejected") || m.getMaterial_Status().equals("Ingredients FullFilled")){
            btnReject.setEnabled(false);
            btnAccept.setEnabled(false);
            if(m.getMaterial_Status().equals("Ingredients FullFilled")){
                lblMsgBox.setText("This order has been FullFilled");
            }
            else{
                lblMsgBox.setText("This order has been Rejected.");
    ...
    private void btnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptActionPerformed
        // TODO add your handling code here:
        MaterialSqlQuery msq = new MaterialSqlQuery();
        m.setMaterial_Status("Ingredients FullFilled");
        msq.updateMaterial(m);
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IndgJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IndgJDialog dialog = new IndgJDialog(new javax.swing.JFrame(), true, m);
